...
addGlobalStyle('#dj-console, #dj-console {background-image: url("http://i.picasion.com/pic64/569eda04807d6484c89ea7a511b1f126.gif");min-height:33px;min-width:131px;}'); //change create room button
...
/*
                if (isBoris())
        API.sendChat("@" + user.username + ", Hi & Welcome, enjoy your time in our room :)) ");
*/
...
//		+ 	'<p id="plugbot-btn-userlist" style="color:#99cb1a">userlist</p>'
		+ 	'<p id="plugbot-btn-facebook" style="color:#99cb1a"><a style="color: #99cb1a" href="http://www.youtube.com/ClownDubstep" target="_blank">ClownDubstepYT</a></p>'
		+ 	'<p id="plugbot-btn-youtube" style="color:#99cb1a"><a style="color: #99cb1a" href="http://www.facebook.com/ClownDubstepOfficial" target="_blank">Facebook Page</a></p>'
    );
}
